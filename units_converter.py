...
def perform_and_how_conversion(unit1: str, unit2: str, factor: float):
    ...
    try:
        ...
        return perform_and_how_conversion(unit1, unit2, factor)
...
while True:
    ...
    if choice == "1":
        if perform_and_how_conversion("inches", "cm", 2.54):
            break
    if choice == "2":
        if perform_and_how_conversion("cm", "inches", 0.394):
            break
